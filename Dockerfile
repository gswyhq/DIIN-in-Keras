...
# docker run --rm -it -v $PWD:/diin -w /diin -p 8000:8000 -e LANG=C.UTF-8 -e TZ=CST-8 tensorflow/tensorflow:1.13.1-py3 /bin/bash
...
# docker build -t diin:20180905 -f Dockerfile .
